...
import os
print(f"DEBUG: Connecting as {os.getenv('SNOWFLAKE_USER')} to DB {os.getenv('SNOWFLAKE_DATABASE')}")
# Check if it prints 'USER' instead of 'USER$BUZYBYTES'—if so, the $ is the problem.
